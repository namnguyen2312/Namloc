...
userCtrl.$inject = ['$scope', 'apiService', 'notificationService', '$ngBootbox'];
function userCtrl($scope, apiService, notificationService, $ngBootbox) {
    ...
    function search(page) {
        ...
        apiService.get('api/appUser/allPage', config, dataLoadCompleted, dataLoadFailed);
    }
