...
roleGroupCtrl.$inject = ['$scope', 'apiService', 'notificationService', '$ngBootbox', '$filter'];
function roleGroupCtrl($scope, apiService, notificationService, $ngBootbox, $filter) {
    ...
    function search(page) {
        ...
        apiService.get('api/appGroup/allPage', config, dataLoadCompleted, dataLoadFailed);
    }
